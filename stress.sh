...
wget https://agora-devops-public-2.oss-cn-beijing.aliyuncs.com/Stress-testing/compressed_tools/linpack_2020.2.001.tar -P ~/linpack/
tar -xvf ~/linpack/linpack_2020.2.001.tar -C ~/linpack/ 1>/dev/null 2>&1
cd ~/linpack/linpack/
